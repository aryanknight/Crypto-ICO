            ...
            <div className="tokenomics-cont">
                ...
                <div className="tokenomics-cont-1" >
                    ...
                    <div className="tokenomics-right">
                        ...
                        <div className="token-para-1" data-aos="fade-up">
                            Marketing, Staking Rewards and Ecosystem: 20% (20% unlocked at TGE, 10% unlocked each month)
                        </div>
                        <div className="token-para-1" data-aos="fade-up">
                        ...
                        <div className="token-para-1" data-aos="fade-up">
                            Public Token Sale: 20% (40% unlocked at TGE followed by 20% every two weeks)
                        </div>
                        <div className="token-para-1" data-aos="fade-up">
                            Partners: 5% (20% unlocked at TGE followed by 20% every two weeks)
                        </div>
                    </div>
