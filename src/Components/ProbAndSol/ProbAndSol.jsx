            ...
            <div className="prob-cont">
                ...
                <div className="prob-cont-1">
                    <div className="prob-cont-text" >
                        <div className="prob-cont-text-head" data-aos="fade-up">PROBLEMS</div>
                        <div className="prob-cont-text-para" data-aos="fade-up">
                    ...
                    <div className="prob-cont-img" data-aos="fade-up">
                ...
                <div className="prob-cont-1" id="prob-2" style={{marginTop:'20px'}} >
                    ...
                    <div className="prob-cont-text">
                        <div className="prob-cont-text-head" data-aos="fade-up">SOLUTIONS</div>
                        <div className="prob-cont-text-para" data-aos="fade-up">
